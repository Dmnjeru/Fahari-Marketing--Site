...
api.interceptors.response.use((resp)=>resp, async (err)=>{
    ...
    if (err.response?.status === 401 && !originalRequest._retry) {
        ...
        isRefreshing = true;
        try {
            const refreshResp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE}/api/admin/refresh`, {}, {
                withCredentials: true
            });
...
function AdminBlogsPage() {
    ...
    const fetchBlogs = async ()=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/api/blogs", {
                params: {
                    admin: true,
                    limit: 1000
                },
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isCancel(err)) {
    ...
    const handleCreate = async (evt)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/blogs", payload);
    ...
    const handleUpdate = async (evt)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/blogs/${form._id}`, payload);
    ...
    const handleDelete = async (id)=>{
        ...
        setBusy(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/blogs/${id}`);
    ...
    const togglePublish = async (b)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/blogs/${b._id}`, payload);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b00049d4._.js.map